...
#Paths
_C.PATHS.RAW_PATH=os.environ.get('DGCNN_RAW_PATH')
...
_C.PATHS.TESTING_RANDOM_PATH=os.environ.get('DGCNN_TEST_RANDOM_PATH')
...
_C.PATHS.TESTING_RANDOM_PREPROC_PATH=os.environ.get('DGCNN_TEST_RANDOM_PREPROC_PATH')
